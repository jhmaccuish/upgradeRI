...
lpath = table2array(readtable('lpathWin'));
lpath = lpath(:,1);
%figure(); 
%plot(21:(20+85),lpath);
title('Labour Supply')
...
title('Mean Partipcation Rate:Simulation vs Data Labour','FontSize',26)
xlabel('Age','FontSize',22)
ylabel('Mean Partipcation Rate','FontSize',22)
legend({'Data','Simulation'},'Location','best','FontSize',22)
...
title('Mean VLA Assets Rate:Simulation vs Data Labour','FontSize',26)
xlabel('Age','FontSize',22)
ylabel('Mean VLA Assets','FontSize',22)
legend({'Data','Simulation'},'Location','best','FontSize',22)
